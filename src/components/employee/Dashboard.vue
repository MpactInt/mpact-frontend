...
<!--              </a>-->
        ...
        <!-- Swiper -->
          <div class="swiper-wrapper">
            <VueSlickCarousel :arrows="true" :dots="true">
              <div v-for="wl in workshopsListDashboard"
                   v-bind:key="wl.id">
                ...
                <span> <img src="../../assets/images/clock.svg" class="icon"
                            alt="workshops image"/> Time: {{ wl.total_hours }}</span>
                  <span> <img src="../../assets/images/avtar.svg" class="icon" alt="workshops image"/> Leader: {{ wl.instructor }}</span>
                </div>
                <button v-if="!wl.registered" class="btn gradient-color-btn mt-4 mb-5" @click="registerForWorkshop(wl.id)">
                  Register Now
                </button>
    ...
    <section class="steps-to-help">
      ...
      <div class="steps-box">
        ...
        <div class="pera">
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi id quam ut dui tristique semper. Lorem ipsum
            dolor sit amet, consectetur adipiscing elit. Morbi id quam ut dui tristique semper.</p>
        </div>
      </div>
      <div class="steps-box">
        <div class="steps-count">
...
export default {
  name: 'Dashboard',
  mixins: [AppMixin],
  components: {CustomSurvey, BarChart, VueSlickCarousel},
  data () {
    return {
      pg: [],
      learningPlan: [],

    ...
    <section>
        <div class="py-6 flex justify-between px-8">
            <p class="uppercase text-4xl text-gray-400 dark:text-gray-500 uppercase font-bold">
                <span class="text-[#090446]">Post Workshop Survey Questions</span>
            </p>
        </div>
        <div class="w-full">
            <div class="py-6 px-8">
                <div class="flex justify-between py-6">
                    <form class="flex items-center">
                        ...
                        <div class="relative w-full">
                            ...
                            <input type="text" id="simple-search"
                                ...
                                placeholder="Search" required v-model="searchData.keyword" v-on:keyup="getPostWorkshopSurveyList">
                        </div>
                    </form>
                    <div class="flex flex-row space-x-1">
                        <button
                            ...
                            <span class="flex-1 text-white ml-3 whitespace-nowrap" v-b-modal.add-modal>Add Post Workshop Survey</span>
                        </button>
                    </div>
                </div>
                ...
                <div class="relative overflow-x-auto shadow-md">
                    <table class="w-full text-sm text-center text-white">
                        ...
                        <tbody class="text-[#090446]">
                            <tr class="bg-white hover:bg-gray-50" v-if="postWorkshopSurveyLength" v-for="p in postWorkshopSurvey.data" v-bind:key="p.id">
                                <td scope="row"
                                ...
                                <td
                                    ...
                                    <button
                                        class="flex items-center px-3 py-1 rounded-md bg-white text-black text-center text-md font-medium shadow border-2" @click="getPostWorkshopSurvey(p)">
                                    ...
                                    <button
                                        class="flex items-center px-3 py-1 rounded-md bg-white text-black text-center text-md shadow border-2" @click="deletePostWorkshopSurvey(p.id)">
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                            ...
                            <tr class="bg-white hover:bg-gray-50" v-if="!postWorkshopSurveyLength">

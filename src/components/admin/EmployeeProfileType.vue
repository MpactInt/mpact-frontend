    ...
    <section>
        <div class="py-6 flex justify-between px-8">
            <p class="uppercase text-4xl text-gray-400 dark:text-gray-500 uppercase font-bold">
                <span class="text-[#090446]">Profile Type</span>
            </p>
        </div>
                ...
                <div class="flex justify-between py-6">
                    <form class="flex items-center">
                        ...
                        <div class="relative w-full">
                            ...
                            <input type="text" id="simple-search"
                                ...
                                placeholder="Search" required v-model="searchData.keyword" v-on:keyup="getProfileTypeList">
                        </div>
                    </form>
                    ...
                    <div class="flex flex-row space-x-1">
                        <button
                            ...
                            <span class="flex-1 text-white ml-3 whitespace-nowrap" v-b-modal.add-profile-type-modal>Add Profile Type</span>
                        </button>
                    </div>
                </div>
                ...
                <div class="relative overflow-x-auto shadow-md">
                    <table class="w-full text-sm text-center text-white">
                        ...
                        <tbody class="text-[#090446]">
                            <tr class="bg-white hover:bg-gray-50" v-if="profileType.length" v-for="p in profileType" v-bind:key="p.id">
                                <td scope="row"
                                    class="px-6 py-4 border-r border-gray-300 font-medium whitespace-nowrap">
                                    {{ p.profile_type }}
                                </td>
                                <td class="px-6 py-4 border-r border-gray-300">
                                    <a class="link" @click="downloadProfileTypeFile(p.id, p.file)">{{ p.file }}</a>
                                </td>
                                <td
                                    class="px-6 py-4 border-r border-gray-300 flex items-center justify-around space-x-2 px-1 border-r border-gray-300">
                                    <button
                                        class="flex items-center px-3 py-1 rounded-md bg-white text-black text-center text-md font-medium shadow border-2" @click="getProfileType(p)">
                                    ...
                                    <button
                                        class="flex items-center px-3 py-1 rounded-md bg-white text-black text-center text-md shadow border-2" @click="deleteProfileType(p.id)">
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                            ...
                            <tr class="bg-white hover:bg-gray-50" v-if="!profileType.length">
                                <td scope="row"
                                    class="px-6 py-4 border-r border-gray-300 font-medium whitespace-nowrap"colspan="3">No Data Found</td>
                            </tr>
                        </tbody>
                    </table>
                </div>

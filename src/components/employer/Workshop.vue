...
<div>
    <div class="my-6 w-full px-8">
        <p class="text-[46px] text-gray-400 dark:text-gray-500 uppercase font-bold">
            <span class="text-[#090446]">Upcoming workshop</span>
        </p>
    </div>
    <div class="space-y-2 space-x-2">
        <!-- card-7 stat -->
        <div class="grid grid-cols-4 p-[20px] space-x-4 bg-[#F2F2F2] rounded-[18px]" >
            <div class="col-span-3">
                <router-link :to="'/employee/workshop/' + upcomingWorkshop.id">
                    <img class="object-cover rounded-[15px] w-[100%] h-[25rem]" :src="filePath + '/' + upcomingWorkshop.image" alt="product image" />
                </router-link>
            </div>
                ...
                <div class="px-2 pb-4">
                    <router-link :to="'/employee/workshop/' + upcomingWorkshop.id">
                        <p class="font-bold text-[24px] tracking-tight">
                            <span class="text-[#BE0858]">{{ upcomingWorkshop.title }}</span>
                        </p>
                    </router-link>

                    <p class="text-sm text-justify text-gray-500 leading-6 py-2">
                    ...
                    <div class="flex flex-col py-1">
                        <p class="inline-flex my-2">
                            ...
                            <span class="font-bold">{{ upcomingWorkshop.instructor }}</span>
                        ...
                        <p class="inline-flex my-2">
                            ...
                            <span class="font-bold">{{ upcomingWorkshop.total_hours }} Hour(s)</span>
                        </p>
                        <p class="inline-flex my-2">
                            <span class="mr-1">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            ...
                            <span>Date:&nbsp;</span> <span class="font-bold">{{ upcomingWorkshop.date | timeStampToDateOnly }} {{upcomingWorkshop.date | timeStampToTimeOnly}}</span>
                        </p>
                    </div>
                </div>
                <div class="rounded">
                    <button
                        class="flex items-center font-sixe-[20px] px-12 py-2 mx-0 rounded-md bg-[#0A0446] text-white text-center text-md border border-1 border-black" v-if="!upcomingWorkshop.registered" @click="registerForWorkshop(upcomingWorkshop.id)">
                        Register Now
                    </button>
                    <button
                        class="flex items-center font-sixe-[20px] px-12 py-2 mx-0 rounded-md bg-[#0A0446] text-white text-center text-md border border-1 border-black" v-if="upcomingWorkshop.registered">
                        Registered
                    </button>   
                </div>
            </div>
        ...
        <div class="grid grid-cols-4 p-[20px] space-x-4 bg-[#F2F2F2] rounded-[18px]" v-if="workshopsLength" v-for="w in workshopsList.data" v-bind:key="w.id">
            ...
            <div class=" rounded-lg text-[#0A0446]">
                <div class="px-2 pb-4">
                    ...
                    <p class="text-sm text-justify text-gray-500 leading-6 py-2">
                        {{ w.description }}
                        <router-link :to="'/employer/view-workshop/' + w.id" class="font-medium text-[#BE0858]">Read More...</router-link>
                    </p>
                    ...
                    <div class="flex flex-col py-1">
                        ...
                        <p class="inline-flex my-2">
                            ...
                            <span>Date:&nbsp;</span> <span class="font-bold">{{ w.date | timeStampToDateOnly }} {{w.date | timeStampToTimeOnly}}</span>
                        </p>
                    </div>
                </div>
                <div class="rounded">
...
import List from '../common/workshops/List.vue'
export default {

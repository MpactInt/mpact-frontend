...
<section>
    ...
    <div class="w-full">
        <div class="mx-5 flex flex-wrap space-x-1 items-center">
            ...
            <button
                class="mm-1 flex items-center font-sixe-[20px] px-12 py-2 mx-8 rounded-md bg-[#BE0858] text-white text-center text-md shadow">
                <span class="flex-1 ml-3 whitespace-nowrap">
        ...
        <div class="w-full">
            <div class="p-6 flex justify-between px-8">
                <form class="w-full" @submit="uploadLogo" ref="createCompanyForm" enctype="multipart/form-data">
                    <div class="flex flex-wrap -mx-3 mb-2">
                        <div class="flex items-center justify-center w-full m-0 px-3 mb-4">
                            <div class="flex flex-col w-full">
                                <p class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Upload Your Logo *</p>
                                <label for="logo"
                                ...
                                <input type="file" class="hidden" ref="logo" id="logo" @change="fileOnChange" accept=".jpg, .jpeg, .png" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mx-auto ">
                        <button
                            class="b-0 flex items-center font-sixe-[20px] px-12 py-2  rounded-md bg-[#0A0446] text-white text-center text-md border border-1 border-black" type="submit" :disabled="upload.disabled">
                            Submit
                        </button>
                    </div>
                </form>

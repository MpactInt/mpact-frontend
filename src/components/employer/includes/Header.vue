        ...
        <nav class="sticky top-0 z-50 w-full bg-white border-b border-gray-200">
            <div class="flex flex-wrap justify-between items-center py-4 px-6">
                <div id="tutorial_setup_logo">
                     <router-link to="/employer/dashboard"  class="flex items-center">
                ...
                <div class="flex">
                    ...
                    <button type="button" class="font-medium mr-10" @click="handleClick">Site Tutorial</button>
                    ...
                    <div id="mega-menu-full"
                        ...
                        <ul
                            ...
                            <li class="outline outline-offset-2 outline-1 rounded">
                                <router-link to="/employer/request-workshop"  class="flex items-center p-2 text-gray-900 rounded-lg">
                                    ...
                                    <span id="tutorial_setup_custom-wr" class="flex-1 text-[#0A0446] ml-3 whitespace-nowrap">Custom Workshop Requests</span>
                                </router-link>
                            </li>
                        </ul>
                    </div>
...
export default {
    ...
    methods: 
    {
        handleClick() 
        {
          ...
          window.location.href = baseUrl+"/employer/dashbaord";
        }
    },
    created() 
    {

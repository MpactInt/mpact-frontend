<template>
    <div class="header">
        <nav class="navbar navbar-expand-lg navbar-light ">
            ...
            <button class="navbar-toggler"  type="button" data-bs-toggle="collapse" data-bs-target="#employerSidebar" aria-controls="employerSidebar" aria-expanded="false" aria-label="Toggle navigation">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto cutom-menu-list">
                    ...
                    <li class="nav-item">
                        <router-link class="nav-link pd-link" to="/employer/ask-question">Ask a question </router-link>
                    </li>
                    <li class="nav-item">
